                                ...
                                <form method="post" action="${pageContext.request.contextPath}/user/updateProfile">
                                    ...
                                    <div class="row pt-1">
                                        <div class="col-12 mb-3">
                                            ...
                                            <p class="text-muted text-center"><%=user.getEmail()%>
                                            </p>
                                            <%if (isUpdateMode) {%>
                                    ...
                                    <div class="row pt-1">
                                        <div class="col-6 mb-3">
                                            ...
                                            <% if (!isUpdateMode) {%>
                                            <p class="text-muted text-center"><%=user.getFirstName() != null ? user.getFirstName() : "-"%>
                                            </p>
                                            <%} else {%>
                                            <input class="text-center form-control" type="text" name="firstname"
                                        ...
                                        <div class="col-6 mb-3">
                                            ...
                                            <% if (!isUpdateMode) {%>
                                            <p class="text-muted text-center"><%=user.getLastName() != null ? user.getLastName() : "-"%>
                                            </p>
                                            <%} else {%>
                                            <input class="text-center form-control" type="text" name="lastname"
                                        ...
                                        <div class="col-12 mb-3">
                                            <div class="d-flex justify-content-center align-content-center">
                                                ...
                                                <a href="${pageContext.request.contextPath}/user/update"
                                                   class="btn btn-primary mx-2">Update my account</a>
                                                <a onclick="return confirm('Are you sure ? ')"
                                                   href="${pageContext.request.contextPath}/user/delete?id=<%=user.getId()%>"
                                                   class="btn btn-danger">Delete my account</a>
                                                <%} else {%>
